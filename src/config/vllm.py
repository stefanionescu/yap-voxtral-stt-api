...
VLLM_GPU_MEMORY_UTILIZATION = _float_env("VLLM_GPU_MEMORY_UTILIZATION", 0.90)

VLLM_MAX_MODEL_LEN = _int_env("VLLM_MAX_MODEL_LEN", 131072)
VLLM_MAX_NUM_SEQS = _int_env("VLLM_MAX_NUM_SEQS", 128)
VLLM_MAX_NUM_BATCHED_TOKENS = _int_env("VLLM_MAX_NUM_BATCHED_TOKENS", 4096)

VLLM_ENFORCE_EAGER = _bool_env("VLLM_ENFORCE_EAGER", True)
